...
<div id="layered_block_left" class="block">
	<h3 class="title_block"> <span>{l s='Shop by' mod='blocklayered'}</span></h3>
									...
									{if $filter.type == $filter_type && isset($filter.values)}
										{if isset($filter.slider)}
											{if $smarty.foreach.f_values.first}
												<li>
													<a href="#" data-rel="layered_{$filter.type}_slider" title="{l s='Cancel' mod='blocklayered'}"><i class="fa fa-remove"></i></a>
													{if $filter.format == 1}
				...
				{foreach from=$filters item=filter}
					{if isset($filter.values)}
                        ...
                        <div class="layered_subtitle_heading">
                            <span class="layered_subtitle titleFont">{$filter.name|escape:'html':'UTF-8'}</span>
