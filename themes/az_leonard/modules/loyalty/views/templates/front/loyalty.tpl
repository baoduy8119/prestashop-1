...
<ul class="footer_links clearfix">
	<li>
		<a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Back to Your Account' mod='loyalty'}" rel="nofollow"><span><i class="fa fa-chevron-left left"></i>{l s='Back to Your Account' mod='loyalty'}</span></a>
	</li>
	<li>
		<a class="btn btn-default button button-small" href="{$base_dir}" title="{l s='Home' mod='loyalty'}"><span><i class="fa fa-chevron-left left"></i>{l s='Home' mod='loyalty'}</span></a>
	</li>
</ul>
