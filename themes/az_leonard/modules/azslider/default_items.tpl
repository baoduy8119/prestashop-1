				...
				<div class="product-image-container">
					...
					<div class="label-box">
						...
						{if $items->params.show_sale == 1 && isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}
							...
							{elseif isset($product.reduction) && $product.reduction && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}<span class="sale-box">{l s='Sale' mod='azslider'}</span>
						{/if}
					</div>
