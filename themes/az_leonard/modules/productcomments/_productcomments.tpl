					...
					<div class="comment_details">
						...
						<ul>
							{if $comment.total_advice > 0}
								<li>
									<i class="fa fa-caret-right"></i> {l s='%1$d out of %2$d people found this review useful.' sprintf=[$comment.total_useful,$comment.total_advice] mod='productcomments'}
								</li>
							{/if}
							{if $is_logged}
								{if !$comment.customer_advice}
								<li>
									<i class="fa fa-caret-right"></i> {l s='Was this comment useful to you?' mod='productcomments'}
								...
								<li>
									<span class="report_btn" data-id-product-comment="{$comment.id_product_comment}">
										<i class="fa fa-caret-right"></i> {l s='Report abuse' mod='productcomments'}
									</span>
								</li>
								{/if}
							{/if}
			...
			<div class="row">
				{if isset($product) && $product}
					<div class="product clearfix  col-xs-12 col-sm-6">
						<img src="{$productcomment_cover_image}" height="{$homeSize.height}" width="{$homeSize.width}" alt="{$product->name|escape:'html':'UTF-8'}" />
				...
				<div class="new_comment_form_content col-xs-12 col-sm-6">
					...
					<div id="new_comment_form_footer">
						...
						<div>
							<a id="submitNewMessage" name="submitMessage" type="submit" class="btn button button-small">
