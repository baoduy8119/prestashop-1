	...
	if (view == 'list')
	{
		...
		$('.product_list .ajax_block_product').each(function(index, element) {
			...
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-4 col-sm-12 col-md-4 col-lg-4">' + $(element).find('.left-block').html() + '</div>';
				html += '<div class="right-block col-xs-4 col-sm-12 col-md-8 col-lg-8">';
					...
					html += '<div class="button-cart">'+ $(element).find('.button-cart').html() +'</div>';
				html += '</div></div>';
			html += '</div></div>';
		$(element).html(html);
		});
