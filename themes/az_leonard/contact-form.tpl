	...
	<div class="contact-form">
		<div class="contact-wrap row">
			<div class="gmap col-sm-12">
				<img src="../themes/az_leonard/img/contact/map.jpg" alt="#" />
				<div class="contact-info">
					<div class="contact-logo"><img src="../themes/az_leonard/img/contact/logo.png" alt="#" /></div>
					<div class="social">
					...
					<div class="info">
						<ul>
							<li class="address">
								<span>81 Gordon Rd, Mandurah WA 6210</span>
							</li>
							<li class="email">
								<span><a href="#">yourcompany@gmail.com</a></span>
							</li>
							<li class="hotline">
			...
			<div class="contact-content">
				<form action="{$request_uri}" method="post" class="contact-form-box col-md-12 col-sm-12" enctype="multipart/form-data">
					<fieldset>
						<h2 class="title titleFont">{l s='We will love to hear from you'}</h2>
						<div class="row">
							...
							<div class="col-md-6 col-sm-6">
								{if !$PS_CATALOG_MODE}
									...
									{if isset($is_logged) && $is_logged}
										<div class="form-group unvisible product selector1">
							...
							<div class="col-md-12 col-sm-12">
								<textarea class="form-control" id="message" name="message" placeholder="Message">{if isset($message)}{$message|escape:'html':'UTF-8'|stripslashes}{/if}</textarea>
							</div>
						</div>
						<div class="submit">
							<button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-default button-medium">
								{l s='Send messages'}</span>
							</button>
						</div>
					</fieldset>
				</form>
