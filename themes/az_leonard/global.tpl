...
{/if}
{addJsDefL name=remove_compare_item}{l s='Product successfully removed from the product comparison' js=1}{/addJsDefL}
{addJsDefL name=add_compare_item}{l s='Product successfully added to the product comparison' js=1}{/addJsDefL}
