    ...
    <ul class="aztabs-tabs cf">
        {foreach $_list as $tab}
            ...
            {if $items->params.filter_type == 'categories'}
                <li class="aztabs-tab {$tab_sel|escape:'html':'UTF-8'} {$tab_all|escape:'html':'UTF-8'}"
                    ...
                    {if $items->params.display_icon == 1}
                        ...
                        {else}
                            <div class="aztabs-tab-img">
                                <img class="cat-all" src="{$base_dir|escape:'html':'UTF-8'}/modules/aztabs/views/img/icon-catall.png"
            ...
            {else}
                <li class="aztabs-tab {$tab_sel|escape:'html':'UTF-8'}"
                    data-category-id="{$tab['id_category']|escape:'html':'UTF-8'}"
                    data-active-content=".items-category-{$active_content|escape:'html':'UTF-8'}">
					<span class="aztabs-tab-label">
                        {$tab['name']|escape:'html':'UTF-8'}
