...
class AzSlideGroup extends ObjectModel
{
	public $title;
	public $active;
	public $position;
	...
	public static $definition = array(
		'table' => 'azhomeslider_groups',
		'primary' => 'id_azhomeslider_groups',
		'multilang' => true,
		'fields' => array(
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'azhomeslider_groups_shop` (`id_shop`, `id_azhomeslider_groups`)
