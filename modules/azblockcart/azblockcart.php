...
class azBlockCart extends Module
{
	public function __construct()
	{
		$this->name = 'azblockcart';
		...
		$this->displayName = $this->l('AZ Shopping Cart');
	...
	public function hookRightColumn($params)
	{
		...
		return $this->display(__FILE__, 'azblockcart.tpl');
	}
	...
	public function hookHeader()
	{
		...
		$this->context->controller->addCSS(($this->_path).'css/azblockcart.css', 'all');
