...
*  @copyright  2007-2013 AZTemplates SA
...
class azBlockLanguages extends Module
{
	public function __construct()
	{
		$this->name = 'azblocklanguages';
		...
		$this->displayName = $this->l('AZ Language Block');
	...
	*/
	public function hookdisplayTopNav($params)
	{
		...
		if (!$this->_prepareHook($params))
			return;
		return $this->display(__FILE__, 'azblocklanguages.tpl');
	}
	...
	public function hookdisplayHeader($params)
	{
		...
		$this->context->controller->addCSS($this->_path.'css/azblocklanguages.css', 'all');
	}
}
