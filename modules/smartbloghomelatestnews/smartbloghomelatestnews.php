...
class smartbloghomelatestnews extends Module {
     ...
     public function install(){
            ...
            return false;
                 Configuration::updateGlobalValue('smartshowhomepost',2);
                 return true;
            }
     ...
     public function hookdisplayHomeNews($params) {
		...
		public function hookdisplayHomeNews2($params) {
                ...
                else
                {
                            ...
                            return $this->display(__FILE__, 'smartblog_latest_news2.tpl', $this->getCacheId());
                }  
            }
		...
		public function hookdisplayHomeNews3($params) {
                ...
                else
                {
                            ...
                            return $this->display(__FILE__, 'smartblog_latest_news3.tpl', $this->getCacheId());
                }  
            }
