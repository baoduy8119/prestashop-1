...
<?php /*%%SmartyHeaderCode:1923581dd0253575a8-40107265%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1923581dd0253575a8-40107265',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_581dd0254e2fe6_79075233',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_581dd0254e2fe6_79075233')) {function content_581dd0254e2fe6_79075233($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'C:\\xampp\\htdocs\\prestashop\\tools\\smarty\\plugins\\function.math.php';
?>
...
<?php $_tmp8=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["myfile"] = new Smarty_variable("img/m/".$_tmp8.".jpg", null, 0);?>
							<?php if (file_exists($_smarty_tpl->tpl_vars['myfile']->value)) {?>
								<?php if ($_smarty_tpl->tpl_vars['params']->value['manu_image_size']=='none') {?>
									<?php ob_start();?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["src"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['img_manu_dir']->value).$_tmp9.".jpg", null, 0);?>
								<?php } else { ?>
									<?php ob_start();?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php $_tmp10=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["src"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['img_manu_dir']->value).$_tmp10."-".((string)$_smarty_tpl->tpl_vars['params']->value['manu_image_size']).".jpg", null, 0);?>
								<?php }?>
								<div class="item">
