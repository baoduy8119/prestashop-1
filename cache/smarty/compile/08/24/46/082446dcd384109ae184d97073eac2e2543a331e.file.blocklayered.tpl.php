<?php /* Smarty version Smarty-3.1.19, created on 2016-11-06 23:05:47
         compiled from "C:\xampp\htdocs\prestashop\themes\az_leonard\modules\blocklayered\blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9158581ffd9bcadcb0-19813734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '082446dcd384109ae184d97073eac2e2543a331e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\themes\\az_leonard\\modules\\blocklayered\\blocklayered.tpl',
      1 => 1478348055,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9158581ffd9bcadcb0-19813734',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_581ffd9c1c5339_17979287',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_581ffd9c1c5339_17979287')) {function content_581ffd9c1c5339_17979287($_smarty_tpl) {?>

<?php if ($_smarty_tpl->tpl_vars['nbr_filterBlocks']->value!=0) {?>
<div id="layered_block_left" class="block">
	<h3 class="title_block"> <span><?php echo smartyTranslate(array('s'=>'Shop by','mod'=>'blocklayered'),$_smarty_tpl);?>
</span></h3>
		...
		<form action="#" id="layered_form">
			<div>
				...
				<div id="enabled_filters">
					<span class="layered_subtitle titleFont" style="float: none;">
...
" style="display: none;">
                        ...
                        <div class="layered_subtitle_heading">
                            <span class="layered_subtitle titleFont"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</span>
...
<script type="text/javascript">
	...
	(function($){
		$(".layered_filter li label").each(function(){
		   $(this).on('click', function(){
				if(!$(this).hasClass('checked'))
					$(this).parents('.hiddable').addClass('selected');
